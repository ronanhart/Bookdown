...
knitr::include_graphics("../Database/Directory Structure.png")
```
...
knitr::include_graphics("../Database/Database_Structure.jpg")
```
...
knitr::include_graphics("../Database/colnames.jpg")
```
...
# Load Data ----
df = read.csv("../Data/Raw/GPS/full_data.csv")
```
...
saveRDS(indiv, "../Data/Processed/individual.rds")
```
<br>
...
saveRDS(collar, "../Data/Processed/collar.rds")
```
<br>
...
# Save ----
saveRDS(loc, "../Data/Processed/location.rds")
```
<br>
...
saveRDS(deploy, "../Data/Processed/deployment.rds")
